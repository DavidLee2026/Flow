...
> 小时候，我们都画过画。
> 后来某一天起，我们不画了——不是因为不爱画，而是因为听到过一句"你画得不像"。
> 那句话像一根刺，悄悄剪断了我们和画画之间那根细细的线。
> **绘心 Flow 想做的，只是把那根线接回去。**

**手机 + 纸 + 笔 + AI**：画你想画的，拍下来，AI 陪你一起看画面。没有对错，不需要画得多好——画得歪歪扭扭也没关系，画什么就画什么。

这里没有评分、没有打卡、没有"画得不好"。只有一位永远不扫兴的画伴：认出你画的东西，看见你的尝试，把每一次"画得不够好"，翻译成"又探索了一个新方向"。

> 不帮你画得更好，而是让你相信自己可以画。

设一个昵称和 4 位 PIN，你的画作只属于你——换个设备登录回来，一切还在。
