            ...
            messages=[
                {
                    "role": "system",
                    "content": (
                        "你是一个绘画陪伴助手。用户画了一幅画并收到 AI 反馈，"
                        "现在让用户回顾'这次画得最满意、最有感觉的地方'。\n"
                        "请生成 3 个反思快选标签，站在用户第一人称视角表达真实感受"
                        "（如'注意到了明暗'、'线条更稳了'），口语化、像人话。\n"
                        "注意：不要生硬照搬反馈里的技术术语拼凑（如'眼睛明暗''光影比例'"
                        "这类读不通的组合），要说清满意在哪个地方。\n"
                        "每个标签 6 字以内，去掉'了''的'等虚词。\n"
