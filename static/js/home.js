...
function renderHomeTopInfo(stats) {
  ...
  if (el('homeLetterBody')) {
    el('homeLetterBody').innerHTML = total >= 5
      ...
      : '欢迎来到绘心 Flow。我是小绘，你纸笔绘画路上的画友。这里没有打分，只有看见——画得歪歪扭扭也没关系，<span class="hl">哪怕只是一条线，都是你此刻想说的话</span>。找一张纸、一支笔，画下此刻想画的东西，拍给我看。我会认真看你的每一笔，告诉你我看到了什么，也看到你越来越有自己的味道。不用画得像，画下去，就有惊喜。';
  }
  if (el('homeTip')) {
    el('homeTip').innerHTML = total >= 5
      ? '💡 再画一张发给我，<b>看看这次哪里又进步了</b>。'
      : '💡 找张纸、画一笔、拍下来，<b>我把看到的告诉你</b>。';
  }
