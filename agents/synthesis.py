...
def _build_synthesis_prompt(
    ...
    layers_spec += (
        '    {\n'
        '      "type": "suggestion",\n'
        '      "content": "一个具体可操作的技巧建议，针对这幅画怎么改会更好。只给一条，且与期待层的新主题方向区分开（建议层讲技巧、期待层讲展望）。如果用到术语必须紧跟大白话解释。",\n'
        '      "tip": "可选：详细的技巧说明。没有就填null。"\n'
        '    },\n'
        '    {\n'
        '      "type": "encourage",\n'
        '      "content": "以真诚的鼓励收尾，肯定 ta 的投入、进步或独特之处。然后自然地引出对未来创作的一个期待或一个新主题方向——不要重复技巧建议（那是建议层的职责），聚焦情感与展望。2句话内。"\n'
        '    }\n'
    )
